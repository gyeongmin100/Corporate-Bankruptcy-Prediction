...
| 외부 검증 (23년 변형의견 기업 36개) | **Recall 72.2%** (26/36 탐지) |
...
- **자기자본증가율**이 낮을수록, **유동비율**이 낮을수록 부도 방향으로 가장 크게 작용 — 단, 라벨 0 선정 기준에 유동비율이 포함되어 효과가 과대평가될 수 있음 (한계 참고)
- 차입금의존도, 타인자본구성비율, 매입채무 대 재고자산비율이 높을수록 부도 방향

### 6. 오분류 분석

FN(실제 1인데 0으로 예측) 10개 기업을 SHAP로 개별 분석:
